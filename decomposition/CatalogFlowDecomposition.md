...
## Экран Catalogue (est: 260 минут; fact: x минут).

### Module 1:
#### Верстка
- Создание таблицы (UITableView) для отображения коллекций NFT (est: 60 минут; fact: x минут).
- Верстка ячеек для отображения информации о коллекциях NFT (est: 80 минут; fact: x минут).
- Добавление обложки, названия коллекции и количества NFT в каждой ячейке (est: 60 минут; fact: x минут).

**Total:** est: 200 минут; fact: x минут.

#### Логика
- Обработка нажатия на ячейку для перехода на экран коллекции NFT (est: 60 минут; fact: x минут).

**Total:** est: 60 минут; fact: x минут.
